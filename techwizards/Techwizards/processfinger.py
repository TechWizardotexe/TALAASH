...
import cv2
def finger():
    sample = cv2.imread("C:\\Users\\milin\\Desktop\\techhacks\\Hackathon\\techwizards\\Techwizards\\static\\fingerprint.bmp")

    best_score = 0
    filename = None
    image = None
    kp1, kp2, mp = None, None, None
    for file in [file for file in os.listdir("C:\\Users\\milin\\Desktop\\techhacks\\Hackathon\\techwizards\\Techwizards\\fingerdata")]:
        fingerprint_image = cv2.imread("C:\\Users\\milin\\Desktop\\techhacks\\Hackathon\\techwizards\\Techwizards\\fingerdata\\" + file)
        sift = cv2.SIFT_create()
